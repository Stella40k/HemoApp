...
export default function EmailSentPage() {
  return (
    <div className="min-h-scree bg-gray-50 flex items-center justify-center p-6">
      <Card className="w-full max-w-md text-center shadow-2xl">
        <CardHeader>
          <div className="mx-auto mb-4 w-16 h-16 bg-red-100 rounded-full flex items-center justify-center">
            <Mail className="w-8 h-8 text-[#e74c3c]" />
          </div>
          <CardTitle className="text-2xl front-bold text-gray-800">
        ...
        <CardContent className="space-y-6">
          <p className="text-sm text-gray-700">
            La verificacion es necesaria para completar el registro y puedas
            comenzar a salvar vidas. Por favor, haz clic en el enlace para{" "}

...
export default function DonorStatusPage({ user, onLogout, onUpdateUser }) {
  ...
  const donationCount =
    (user?.donations || []).length || user?.donationCount || 0;
      ...
      <div className="container mx-auto py-8 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground mb-8">
            Actualizá tu estado y mirá el impacto estimado
          </p>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Cambiá tu estado para que las instituciones sepan tu
                    disponibilidad
                  </p>
                </div>
              </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Última donación y el historial están disponibles en tu perfil.
              </p>
            </CardContent>
          </Card>
        </div>

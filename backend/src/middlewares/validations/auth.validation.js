...
export const registerValidation = [
  body("email")
    .isEmail()
    .withMessage("El emild eebe ser valido")
    .normalizeEmail()
    .custom(async (email) => {
  ...
  body("userName")
    ...
    .withMessage("El nombre puede ser entre 3 a 20 caracteres")
    .matches(/^[a-zA-Z0-9_.]+$/)
    .withMessage("Solo letras, números, puntos y guiones bajos")
  ...
  body("institutionData.cuit")
    ...
    .notEmpty()
    .withMessage("El CUIT es obligatorio para las instituciones")
    .matches(/^\d{11}$/)
...
export const loginValidation = [
  body("email").optional().isEmail().withMessage("Ingrese email valido"),
  body("userName")
    .optional()
    .isLength({ min: 3 })
  ...
  (req, res, next) => {
    //pongo aca para no importar mchas cosas en las rutas
